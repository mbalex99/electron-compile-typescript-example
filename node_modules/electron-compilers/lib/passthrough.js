...
var PassthroughCompiler = function (_SimpleCompilerBase) {
  _inherits(PassthroughCompiler, _SimpleCompilerBase);

  function PassthroughCompiler() {
    _classCallCheck(this, PassthroughCompiler);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(PassthroughCompiler).call(this));
  }

  _createClass(PassthroughCompiler, [{
    key: 'compileSync',
